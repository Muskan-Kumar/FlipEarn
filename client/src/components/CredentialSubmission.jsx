...
const CredentialSubmission = () => {
  ...
  return (
    ...
    <div className='bg-white sm:rounded-lg shadow-2xl w-full max-w-lg h-screen sm:h-[32-px] flex flex-col'>
        {/* Header */}
        ...
        {/* Form */}
        <form onSubmit={handleSubmission} className='flex flex-col items-start ga-4 p-4 overflow-y-scroll'>
