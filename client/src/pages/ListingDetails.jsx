...
const ListingDetails = () => {
  ...
  const prevSlide = ()=> setCurrent((prev)=> (prev === 0 ? images.lenght - 1 : prev - 1))

  const nextSlide = ()=> setCurrent((prev)=> (prev === images.lenght - 1 ? 0 : prev + 1))
          ...
          {images?.length > 0 && (
            <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
              ...
              <div className='relative w-full aspect-video overflow-hidden'>
                ...
                {/* Dots Indicator */}
                <div className='absolute bottom-3 left-1/2 -translate-xl-1/2 flex gap-2'>
                  {images.map((_, index)=>(
