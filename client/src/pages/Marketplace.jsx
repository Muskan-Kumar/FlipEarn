...
const Marketplace = () => {
  ...
  const filteredListings = listings.filter((listing)=>{
    ...
    if(filters.maxPrice){
      if(!filters.price > filters.maxPrice) return false
    }

    if(filters.minFollowers){
      if(!filters.followers_count > filters.minFollowers) return false
    }
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div  className='relative flex items-start justify-between gap-8 pb-8'>
        ...
        {/* filter sidebar ko import hua h component se */}
        ...
        {/* Listing card ko import krke dikhaya ja rha h map function se */}
